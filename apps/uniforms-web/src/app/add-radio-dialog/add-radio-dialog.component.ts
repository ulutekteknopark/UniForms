...
@Component({
  ...
  templateUrl: './add-radio-dialog.component.html',
  styleUrl: './add-radio-dialog.component.scss',
})
export class AddRadioDialogComponent {
  @Input() isEditing: boolean = false;
  @Output() addRadioEvent = new EventEmitter<{title: string, required: boolean, choices: object,}>();
